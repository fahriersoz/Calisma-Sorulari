...
C28: This() aynı class in varsayılan Constructor’larını çağırmak için kullanılır, ancak super() onları ebeveyn / temel class tan
...
Q31: 1. saklama alanı; String’ler StringPool'da StringBuilder Heap hafızada
2. İş parçacığı güvenliği; String’ler evet
3. form;
4. Performans; StringBuilder no String’ler Değişmez StringBuilder değiştirilebilir String’ler Hızlı
...
C43: Abstraction(Soyutlama) method ve statik sabitlerin birleşimidir. Herhangi bir Constructor’a sahip değildir.
